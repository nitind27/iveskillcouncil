...
export default function StudentsPage() {
  ...
  const handleDelete = async (student: StudentItem) => {
    const res = await showDeleteConfirm(
      ...
      `Are you sure you want to delete student ${student.studentCode ? `[${student.studentCode}] ` : ""}${student.fullName}? This will permanently remove their enrollment, fee records, attendance, and all associated details. This action cannot be undone.`
    );
    ...
    try {
      ...
      await showSuccess(
        "Student Deleted",
        `Student ${student.fullName} has been deleted successfully.`
      );
      mutate();
                      ...
                      <td className="px-4 py-3 text-right whitespace-nowrap">
                        <div className="inline-flex items-center justify-end gap-1.5">
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-lg border border-border/70 bg-white px-2.5 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-[#1E4A85]/40 hover:bg-[#1E4A85]/5 hover:text-[#1E4A85]"
                          >
                          ...
                          <button
                            ...
                            title="Edit student"
                            className="inline-flex items-center gap-1 rounded-lg border border-blue-200 bg-blue-50/70 px-2.5 py-1.5 text-xs font-semibold text-blue-700 transition hover:border-blue-300 hover:bg-blue-100"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-lg border border-red-200 bg-red-50/70 px-2.5 py-1.5 text-xs font-semibold text-red-600 transition hover:border-red-300 hover:bg-red-100 disabled:opacity-50"
                          >
                            {deletingId === s.id ? (
            ...
            {selected && (
              <>
                ...
                >
                  ...
                  <div className="shrink-0 space-y-2 border-t border-[#1E4A85]/10 px-5 py-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-red-200 bg-red-50 py-2.5 text-xs font-bold text-red-600 transition hover:border-red-300 hover:bg-red-100 disabled:opacity-50"
                      >
                    ...
                    <button
                      type="button"
                      onClick={() => setSelected(null)}
                      className="w-full rounded-xl bg-[#1E4A85] py-2 text-xs font-semibold text-white hover:bg-[#163A6B]"
                    >
                      Close
                    </button>
                  </div>
