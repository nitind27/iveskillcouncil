...
const notifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Payment of $1,234 received",
    time: "1 day ago",
    unread: false,
  },
];

// Menu items with submenus and drawers
      ...
      <div className="flex items-center justify-between h-full px-4 lg:px-6">
              ...
              return (
                ...
                >
                  ...
                  {isHovered && hasChildren && (
                    <div className="absolute top-full left-0 mt-1 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-50 transition-all duration-150 ease-out opacity-100 scale-100">
                  ...
                  {/* Drawer/Mega Menu */}
                  {isHovered && hasDrawer && (
                    <div className="absolute top-full left-0 mt-1 w-[600px] bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-6 z-50 transition-all duration-150 ease-out opacity-100 scale-100">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={notificationRef}>
            ...
            {isNotificationOpen && (
              <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden animate-fast-fade-in z-50">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              ...
              <ChevronDown
                className={cn(
                  "hidden lg:block w-4 h-4 text-gray-500 dark:text-gray-400 transition-transform duration-200",
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden animate-fast-fade-in z-50">
                ...
                <div className="py-1">
                  ...
                  <button
                    onClick={logout}
                    className="w-full flex items-center gap-3 px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left text-red-600 dark:text-red-400"
                  >
